...
class CVSegmentationConfig(Config):
    ...
    LEARNING_RATE = 0.001
    NUM_CLASSES = 2 # background + nuclei
    BACKBONE_STRIDES = [4, 8, 16, 32, 64]
    ...
    # were much larger than CODEX data nuclei
    def __init__(self, smallest_side, increase_factor=2.5, min_confidence=0.8):
        super().__init__()
        self.IMAGE_MIN_DIM = np.ceil(smallest_side * increase_factor / 64) * 64
        self.DETECTION_MIN_CONFIDENCE = min_confidence