...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'dearrayed_tissue_micro_array_cell_segmentation_masks': True}}, 'workflow_parameters': {'nuclear_stain': 'A0', 'membrane_markers': ['A0']}, 'data': {'dearrayed_tissue_micro_array': {'A0': {'A0': {'url': 'tests/data/dearrayed_tissue_micro_array/A0/A0.ome.tiff'}}}}})
        ...
        OutputSchema = {'data': {'dearrayed_tissue_micro_array_cell_segmentation_masks': 'DearrayedTissueMicroArrayCellSegmentationMask'}, 'control': {'CLASS_TYPE': 'enum', 'FIELDS': [{'name': 'success', 'value': 'success'}]}}
