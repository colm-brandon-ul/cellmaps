...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'dearrayed_tissue_micro_array': True}}, 'data': {'dearrayed_tissue_micro_array': {'A0': {'A0': {'url': 'tests/data/dearrayed_tissue_micro_array/A0/A0.ome.tiff'}}}}})
