...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'service_parameters': {'overlap': 56, 'threshold': 32, 'increase_factor': 15, 'grow_mask': False, 'grow_pixels': 41, 'grow_method': 'Sequential'}, 'system_parameters': {'data_flow': {'whole_slide_image_cell_segmentation_masks': False}}, 'workflow_parameters': {'nuclear_stain': 'A0'}, 'data': {'whole_slide_image': {'A0': {'url': 'tests/data/whole_slide_image/A0.ome.tiff'}}}})
        ...
        OutputSchema = {'data': {'whole_slide_image_cell_segmentation_masks': 'WholeSlideImageCellSegmentationMask'}, 'control': {'CLASS_TYPE': 'enum', 'FIELDS': [{'name': 'success', 'value': 'success'}]}}
