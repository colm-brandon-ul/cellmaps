...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'missile_metadata': False, 'missile_counts': False, 'missile_spatial_data': False}}, 'workflow_parameters': {'protein_channel_markers': ['A0']}, 'data': {'dearrayed_tissue_micro_array_missile_fcs': {'A0': {'url': 'tests/data/dearrayed_tissue_micro_array_missile_fcs/A0.csv'}}}})
        ...
        OutputSchema = {'data': {'missile_metadata': 'MissileMetadata', 'missile_counts': 'MissileExpressionCounts', 'missile_spatial_data': 'MissileExpressionSpatialData'}, 'control': {'CLASS_TYPE': 'enum', 'FIELDS': [{'name': 'success', 'value': 'success'}]}}
