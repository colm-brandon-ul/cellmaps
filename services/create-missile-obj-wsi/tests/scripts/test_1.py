...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'workflow_parameters': {'protein_channel_markers': ['A0']}, 'system_parameters': {'data_flow': {'missile_metadata': False, 'missile_counts': True, 'missile_spatial_data': False}}, 'data': {'whole_slide_image_missile_fcs': {'url': 'tests/data/whole_slide_image_missile_fcsA0.csv'}}})
