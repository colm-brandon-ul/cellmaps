...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'dearrayed_tissue_micro_array': True}}, 'workflow_parameters': {'rois': [{'x1': 2427, 'y1': 2396, 'x2': 2825, 'y2': 3714, 'img_w': 3370, 'img_h': 4180}]}, 'data': {'tissue_micro_array': {'A0': {'url': 'tests/data/tissue_micro_array/A0.ome.tiff'}}}})
        ...
        OutputSchema = {'data': {'dearrayed_tissue_micro_array': 'DearrayedTissueMicroArray'}, 'control': {'CLASS_TYPE': 'enum', 'FIELDS': [{'name': 'success', 'value': 'success'}]}}
