...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'dearrayed_tissue_micro_array': True}}, 'workflow_parameters': {'rois': [{'x1': 2493, 'y1': 1089, 'x2': 3830, 'y2': 1232, 'img_w': 4511, 'img_h': 2463}]}, 'data': {'tissue_micro_array': {'A0': {'url': 'tests/data/tissue_micro_array/A0.ome.tiff'}}}})
