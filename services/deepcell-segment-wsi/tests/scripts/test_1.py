...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'whole_slide_image_cell_segmentation_masks': True}}, 'workflow_parameters': {'nuclear_stain': 'A0', 'membrane_markers': ['A0']}, 'data': {'whole_slide_image': {'A0': {'url': 'tests/data/whole_slide_image/A0.ome.tiff'}}}})
