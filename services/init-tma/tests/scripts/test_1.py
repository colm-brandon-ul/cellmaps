...
class InteractiveTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'tissue_micro_array': True, 'nuclear_stain': False, 'nuclear_markers': True, 'membrane_markers': False, 'protein_channel_markers': False}}})
        ...
        # This needs to be generated for the service from the schema
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'workflow_parameters': {'experiment_data_id': 'QpZOqwF7GC', 'nuclear_stain': 'A0', 'nuclear_markers': ['A0'], 'membrane_markers': ['A0'], 'protein_channel_markers': ['A0']}})
