...
class InteractiveTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'tissue_micro_array': False, 'nuclear_stain': True, 'nuclear_markers': False, 'membrane_markers': False, 'protein_channel_markers': False}}})
        ...
        # This needs to be generated for the service from the schema
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'workflow_parameters': {'experiment_data_id': 'zPApxhrAcD', 'nuclear_stain': 'A0', 'nuclear_markers': ['A0'], 'membrane_markers': ['A0'], 'protein_channel_markers': ['A0']}})
        ...
        ProcessOutputSchema = {'data': {'tissue_micro_array': 'TissueMicroArray'}, 'workflow_parameters': {'nuclear_stain': 'NuclearStain', 'nuclear_markers': 'NuclearMarkers', 'membrane_markers': 'MembraneMarkers', 'protein_channel_markers': 'ProteinChannelMarkers'}, 'control': {'CLASS_TYPE': 'enum', 'FIELDS': [{'name': 'success', 'value': 'success'}]}}
