...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'service_parameters': {'numNeighbours': ('int', {'max': 30, 'min': 3})}, 'workflow_parameters': {'protein_channel_markers': ['A0']}, 'system_parameters': {'data_flow': {'missile_clusters': False}}, 'data': {'missile_expressions_counts': {'url': 'tests/data/missile_expressions_countsA0.csv'}}})
