...
class AutomatedTest(unittest.TestCase):
    def test_script_execution(self):
        ...
        env['CINCODEBIO_DATA_PAYLOAD'] = json.dumps({'system_parameters': {'data_flow': {'whole_slide_image_missile_fcs': False}}, 'workflow_parameters': {'nuclear_markers': ['A0'], 'protein_channel_markers': ['A0','A1','A2']}, 'data': {'whole_slide_image': {'A0': {'url': 'tests/data/whole_slide_image/A0.ome.tiff'},'A1': {'url': 'tests/data/whole_slide_image/A0.ome.tiff'},'A2': {'url': 'tests/data/whole_slide_image/A0.ome.tiff'}}, 'whole_slide_image_cell_segmentation_mask': {'nucleus_mask': {'url': 'tests/data/whole_slide_image_cell_segmentation_mask/Anucleus_mask.ome.tiff'}, 'membrane_mask': {'url': 'tests/data/whole_slide_image_cell_segmentation_mask/Amembrane_mask.ome.tiff'}}}})
        ...
        OutputSchema = {'data': {'whole_slide_image_missile_fcs': 'WholeSlideImageMissileFCS'}, 'control': {'CLASS_TYPE': 'enum', 'FIELDS': [{'name': 'success', 'value': 'success'}]}}
